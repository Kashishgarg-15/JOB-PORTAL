...
const PostApplication = () => {
  ...
  const { jobId } = useParams(); //agar url me se data get krna h.
  ...
  const handlePostApplication = (e) => {
    e.preventDefault(); //pure page ko refresh hone se bachaane k liye.
  ...
  useEffect(() => {
    if (user) {
      setName(user.name || "");
      setEmail(user.email || "");      //details already filled honi chahiye jo regsiter hote time di thi user ne.
      setPhone(user.phone || "");
